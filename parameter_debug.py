...
def canny_window():
    ...
    cv.createTrackbar("iteration", "CannyTracking", 0, 10, nothing)
...
def examples_or_camera():
    print('If you want to use examples press 1, if you want to use the camera press 2')
    input1 = int(input())
    if input1 == 1:
